...
li $t5, 2  # {10'b1010101010,5'b00000,7'b0000010 ,5'b00000,5'b00101}
                     ...
                     ########################working till here
sub $t6, $t2, $t3  # {10'b1100101100,5'b00010,7'b0000000 ,5'b00011,5'b00110}   t6 is 2

mult $t6, $t4 #{10'b1111100000,5'b00110,7'b0000000 ,5'b00100,5'b00110}     t6 should be 10
mflo $t6   #combined with previous step 
sub $t7, $t4, $t5 # {10'b1100101100,5'b00100,7'b0000000 ,5'b00101,5'b00111} t7 3
add $t6, $t7, $t6 # {10'b1010101010,5'b00111,7'b0000000 ,5'b00110,5'b00110} t6 should be 13
